...
export namespace sprites {
	...
	export const dfence: tuple = [[72, 30], [24, 30], 0, 'tex/dfence']
	...
	export const dvines: tuple = [[24, 31], [24, 31], 0, 'tex/8bit/dvines']
	export const dvines2: tuple = [[24, 31], [24, 31], 0, 'tex/8bit/dvines2']
	export const dvines3: tuple = [[24, 31], [24, 31], 0, 'tex/8bit/dvines3']
	...
	export const dsquarebarrel: tuple = [[24, 26], [24, 26], 0, 'tex/8bit/dsquarebarrel']

	export const dwoodywalls: tuple = [[264, 40], [24, 40], 0, 'tex/8bit/dwoodywalls']
	export const dplywoodwalls: tuple = [[264, 40], [24, 40], 0, 'tex/8bit/dcommonwalls']
	export const dovergrownwalls: tuple = [[264, 40], [24, 40], 0, 'tex/8bit/dovergrownwalls']
	export const dderingerwalls: tuple = [[264, 40], [24, 40], 0, 'tex/8bit/dsideroomwalls']
	...
	export const dfalsefronts: tuple = [[192, 40], [24, 40], 0, 'tex/8bit/dfalsefronts']
